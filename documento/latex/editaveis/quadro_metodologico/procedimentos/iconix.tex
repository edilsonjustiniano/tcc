...
\newpage
\begin{figure}[h!]
	\centerline{\includegraphics[scale=0.35]{./imagens/diagrama-robustez-localizar-parceiros.png}}
...
\newpage
\begin{figure}[h!]
	\centerline{\includegraphics[angle=90,scale=0.4]{./imagens/diagrama-sequencia-localizar-novos-parceiros.png}}
