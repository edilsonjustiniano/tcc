...
\par Para finalizar o desenvolvimento foram desenvolvidos gráficos que apresentem ao usuário informações a respeito da qualidade do serviço prestado pelo provedor de serviços, comparando-os com os demais prestadores. Esses gráficos foram gerados usando a biblioteca chamada \textit{charts}, disponibilizada no \textit{link} https://developers.google.com/chart. Ela foi incluída na página \textit{index} deste trabalho, permitindo assim o seu funcionamento. O trecho de código~\ref{list:codigo_insercao_charts} demonstra essa inserção.
