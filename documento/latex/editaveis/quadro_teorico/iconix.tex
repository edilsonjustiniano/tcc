...
A fase de análise de requisitos tem como finalidade identificar os objetos do problema real e, a partir desses objetos definir como eles serão abstraídos para o software por meio do modelo de domínio; Também apresenta um protótipo das possíveis interfaces gráficas e, por fim, descrever os casos de uso. Quando possível, elabora-se os diagramas de navegação para que o cliente possa entender melhor o funcionamento do sistema como um todo.
